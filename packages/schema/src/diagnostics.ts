...
export const TOPOIR_DIAGNOSTIC_CODES = [
  ...
  "TOP103_UNSUPPORTED_API_VERSION",
  "TOP104_UNKNOWN_FAMILY",
  "TOP105_FAMILY_NOT_IMPLEMENTED",
  ...
  "TOP253_SOURCE_NOT_FOUND",
  "TOP254_ENTITY_NOT_FOUND",
  "TOP255_MODEL_NOT_FOUND",
  "TOP256_STYLE_CYCLE",
  "TOP257_STYLE_NOT_FOUND",
  "TOP258_COLLAPSE_TARGET_INVALID",
  "TOP259_OCCURRENCE_ELEMENT_NOT_FOUND",
  "TOP260_VIEW_NOT_FOUND",
  "TOP261_CONNECTION_BINDING_INVALID",
  "TOP262_CONNECTION_AMBIGUOUS",
  "TOP263_CONSTRAINT_REFERENCE_NOT_FOUND",
  "TOP264_CONSTRAINTS_CONTRADICT",
  "TOP270_MIGRATION_DEFAULT_APPLIED",
  "TOP271_MIGRATION_NOT_REPRESENTABLE",
  ...
  "TOP460_TEXT_BELOW_MEDIUM_MINIMUM",
  "TOP461_SCALED_TO_FIT",
  "TOP470_CONSTRAINT_UNSUPPORTED",
  "TOP471_CONSTRAINT_NOT_HONOURED",
  "TOP472_MONOTONIC_PATH_IMPOSSIBLE",

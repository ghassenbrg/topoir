/**
 * Synthetic architecture generator shared by the generalization harness and by repro
 * scripts. Seeds are avalanched, so the corpus is diverse and reproducible.
 */
/**
